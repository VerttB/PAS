...
public class AdapterFactory {
    ...
    public SistemaContabilAdapter criarSistemaContabilAdapter(String nome) {
        ...
        else if (nome.equals("SAP")) this.sistemacontabilAdapter = new SistemaContabilAdapterSAP();
    ...
    public SistemaEstoqueAdapter criarSistemaEstoqueAdapter(String nome) {
        ...
        else if (nome.equals("DELL")) this.sistemaestoqueAdapter = new SistemaEstoqueAdapterIBM();
        else if (nome.equals("SAP")) this.sistemaestoqueAdapter = new SistemaEstoqueAdapterIBM();
